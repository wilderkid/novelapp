<template>
  <div class="project-selector">
    <el-dropdown @command="selectProject" trigger="click">
      ...
      <template #dropdown>
        <el-dropdown-menu>
          <el-dropdown-item v-for="project in projects" :key="project.id" :command="project.id">
            {{ project.title }}
          </el-dropdown-item>
    ...
    <el-dialog v-model="newProjectDialogVisible" title="新建项目" width="500px">
      <el-form :model="newProjectForm" label-width="80px">
        <el-form-item label="项目标题">
          <el-input v-model="newProjectForm.title" placeholder="请输入项目标题" />
        </el-form-item>
        <el-form-item label="项目类型">
          <el-select v-model="newProjectForm.genre" placeholder="请选择项目类型" style="width: 100%">
        ...
        <el-form-item label="项目描述">
          <el-input v-model="newProjectForm.description" type="textarea" rows="3" placeholder="请输入项目描述" />
        </el-form-item>
