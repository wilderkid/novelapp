  ...
  <div class="chat-view-layout">
    ...
    <div class="history-sidebar">
      <div class="new-chat-button">
        <el-button type="primary" @click="startNewChat" plain
          >+ 新建对话</el-button
        >
    ...
    <div class="chat-container">
      <div class="chat-header">
        <div class="chat-header-left">
          ...
          <el-dropdown
            trigger="click"
            :visible="showAiModelMenu"
            @update:visible="showAiModelMenu = $event"
            @command="selectAiModel"
            popper-class="ai-model-dropdown-popper"
          >
            <h1
              class="model-title-dropdown"
              :class="{ 'is-model-selected': selectedAiModelId }"
            >
          ...
          >
            <div class="message-content-wrapper">
              ...
              <div class="message" :class="`message-${msg.role}`">
                <!-- 思考过程 -->
                <div
                  v-if="msg.role === 'assistant' && msg.hadThinkingProcess"
            ...
            <div
              v-if="
                (msg.role === 'assistant' || msg.role === 'user') && !isLoading
              "
      ...
      <div class="chat-input-area">
        <div class="input-controls">
          <div class="control-buttons">
            <el-dropdown
              trigger="click"
              :visible="showPromptTemplateMenu"
              @update:visible="showPromptTemplateMenu = $event"
  ...
  ElMessageBox.confirm(
    ...
    .then(async () => {
      try {
        ...
        ElMessage.success(
          `已删除 ${selectedConversations.value.length} 条对话`,
        );
...
onMounted(() => {
  ...
  if (systemStore.settings.chatDefaults) {
    selectedAiModelId.value =
      systemStore.settings.chatDefaults.aiModelId ?? null;
    selectedPromptTemplateId.value =
      systemStore.settings.chatDefaults.promptTemplateId ?? null;
  }
  ...
  try {
    ...
    if (error.response && error.response.status === 400) {
      ...
      if (
        ...
        error.response.data.detail.includes("Project ID")
      ) {
